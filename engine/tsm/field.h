...
namespace dt::tsm
{
    ...
    public:
        ...
        void write(std::chrono::high_resolution_clock::time_point timestamp, std::string & data, std::string & db_name, std::string & tb_name);
        ...
        void notify(const std::string & db_name, const std::string & tb_name, const std::string & field_name, bool is_registered, bool use_index_entry_map) override;  // 通知所有观察者状态发生变化
