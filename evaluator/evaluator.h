...
namespace dt::evaluator
{
    ...
    public:
        ...
        std::shared_ptr<ExecutionPlanNode> eval_select(const std::shared_ptr<ast::Select> & node, const std::shared_ptr<ExecutionPlanNode> & where, const std::shared_ptr<ExecutionPlanNode> & root);

        std::shared_ptr<ExecutionPlanNode> eval_sys(const std::shared_ptr<ast::System> & node, const std::shared_ptr<ExecutionPlanNode> & where);
